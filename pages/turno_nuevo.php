           ...
           ?>
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <br>
                    <center>
                        <h1 class="section-title">Comienzo de Nuevo Turno</h1><br>
                        <h3 class="section-title">De Lunes a Viernes:</h3><br>
                    <form method="POST" action="comienza_turno.php" class="form-group">
                        Ingrese la fecha a agregar: <input class="form-control-lg-6" type="date" name="fecha"><br><br>
                        <input class="btn-success" type="submit" name="cargar" value="CARGAR">
                    </form>
                    <br><br>
                    <h3 class="section-title">Dia Sábado:</h3><br>
                    <form method="POST" action="comienza_turno_sabado.php" class="form-group">
                        Ingrese la fecha a agregar: <input class="form-control-lg-6" type="date" name="fecha"><br><br>
                        <input class="btn-success" type="submit" name="cargar" value="SÁBADO">
                    </form>
                    </center>
				</main>
