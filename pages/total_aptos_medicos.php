        ...
        <div id="layoutSidenav">
           ...
           ?>
            <div id="layoutSidenav_content">
                <main>
                    <h1 class="text-center">Aptos Médicos</h1>    
            ...
            <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                   <?php while ($row = $resultado->fetch_assoc()) { ?>
                    <?php $dia=substr($row['fecha_cargada'],-10,3);
                          $mes =substr($row['fecha_cargada'],-7,2)+1;
                          $anio =substr($row['fecha_cargada'],-5);
                          $fechat = $dia.'0'.$mes.$anio; ?>
                    <tr>
                        <td><?php echo $row['nombre']; ?></td>
                        <td><?php echo $row['apellido']; ?></td>
                        <td><?php echo $row['dni']; ?></td>
                        <td><?php echo $row['fecha_cargada']; ?></td>
                        <td><?php echo $fechat; ?></td>
                        <td><a href=#>VER</a></td>
                        <!-- <td><button type="submit" class=" btn btn-danger">Cancelar</button><button type="submit" class="btn btn-success">Presente</button><button type="submit" class=" btn btn-warning">Ausente</button></td> -->
                    </tr>
                    <?php } ?>
                </tbody>
            </table>  
