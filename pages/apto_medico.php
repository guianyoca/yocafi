<?php
	...
	$sql = "SELECT * FROM aptos_medicos WHERE dni='$dni'";
               ...
               echo " 
                <main>
                    ...
                    <br>            
                        <center>
                            <div class='main'>
                                <h1>Cargar Certificado de Apto Médico</h1>
                    <br>
                        <form enctype='multipart/form-data' action='upload.php' method='POST' class='form-group'>
                            <input type='hidden' name='MAX_FILE_SIZE' value='' class='form-control' />
                            <p> Enviar mi archivo: <input name='subir_archivo' type='file' class='form-control' /></p>
                            <p> <input type='submit' value='Enviar Archivo' class='btn-success' /></p>
                        </form>
                            </div>
                        </center>     
...
";
    ...
    echo "<main>
                    ...
                    <br>            
                        <center>
                            <div class='main'>
                                <h1>Usted ya tiene cargado su apto Médico</h1>
                                </div>
                        </center>     
