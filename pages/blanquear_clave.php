           ...
           ?>
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <br>
                    <center>
                        <h1 class="section-title">Blanquear Clave</h1><br>
                        <h3 class="section-title">Datos del Usuario:</h3><br>
                    <form method="POST" action="blanqueo.php" class="form-group">
                    
                        Ingrese el DNI del afiliado: <input class="form-control-lg-6" type="number" name="dni"><br><br>
                        <input class="btn-success" type="submit" name="cargar" value="BLANQUEAR">
                    </form>
                    </center>
				</main>
