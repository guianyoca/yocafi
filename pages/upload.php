...
<?php
$directorio = "aptos_medicos/$dni";
$subir_archivo = $directorio.basename($_FILES['subir_archivo']['name']);
echo "<div>";
if (move_uploaded_file($_FILES['subir_archivo']['tmp_name'], $subir_archivo)) {
    $sql= "INSERT INTO aptos_medicos (nombre,apellido,dni,ruta,fecha_cargada,hora_cargada) VALUES ('$nombre','$apellido','$dni','$directorio','$fecha','$hora')"; 
...
<h3 align="center"><div align="center"><a href="apto_medico.php">Volver </a></div></h3></div>
