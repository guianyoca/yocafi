                    ...
                    <tr>
                        ...
                        <?php 
                         if ($row['estado']=='Habilitado') {?>
                             <td style='background-color:#D4F7D4'><span class="badge badge-success badge-pill col-6"> Habilitado</span><a href="dar_habilitacion.php?id=<?php echo $row['id']; ?>&nombre=<?php echo $row['nombre']; ?>&apellido=<?php echo $row['apellido']; ?>&dni=<?php echo $row['dni']; ?>&telefono=<?php echo $row['telefono']; ?>&fecha=<?php echo $hoy; ?>&estado=<?php echo 'Suspendido'; ?>"class='btn btn-danger col-6'>Suspender</a></td>
                         <?php     
                         }elseif ($row['estado']=='Deshabilitado') {?>
                             <td style='background-color:#F1D5D7'><span class="badge badge-danger badge-pill col-6"> Suspendido</span><a href="dar_habilitacion.php?id=<?php echo $row['id']; ?>&nombre=<?php echo $row['nombre']; ?>&apellido=<?php echo $row['apellido']; ?>&dni=<?php echo $row['dni']; ?>&telefono=<?php echo $row['telefono']; ?>&fecha=<?php echo $hoy; ?>&estado=<?php echo 'Habilitado'; ?>" class='btn btn-success col-6'>Habilitar</a></td>
                        <?php
                         } else {
                        ?>
